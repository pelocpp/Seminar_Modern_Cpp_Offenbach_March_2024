...
namespace Auto_Examples {
    ...
    static void test_01_a() {
        ...
        //var x;
        //let y;
        auto z = 123.465f;  // type deduction
    ...
    {
        return f1 + f2;  // expression: float
    }

    template <typename T, typename U>
    
    static auto doSomething(bool flag, T f1, U f2) -> decltype (f1 + f2)
    {
        if (flag) {
            return f1;
        }
    ...
    doSomethingAgain(bool flag, T f1, U f2)
    {
        if (flag) {
            return f1;
        }
    ...
    void test_seminar()
    {
        auto result = doSomethingAgain(true, 123.345, 123l);
    }
